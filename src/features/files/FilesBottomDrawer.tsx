...
import '../../styles/files-bottom-drawer.css'
...
export function FilesBottomDrawer({
  ...
  useEffect(
    () => () => {
      ...
      document.body.classList.remove('is-bottom-drawer-resizing')
    },
    [],
  )
  ...
  const beginResize = (event: PointerEvent<HTMLDivElement>) => {
    ...
    document.body.classList.add('is-bottom-drawer-resizing')
  ...
  return (
    ...
    >
      <div
        ref={resizeEdgeRef}
        className="files-bottom-drawer-resize-edge"
        role="separator"
        tabIndex={open ? 0 : -1}
        aria-hidden={!open}
      ...
      />
      <div className="files-bottom-drawer-surface">
        {children}
      </div>
    </section>
  )
