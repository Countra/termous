...
export default function UpdateWindowRoot() {
  ...
  const releasePageUrl = termousReleasePageUrl(currentVersion)
  const releasePageLabel = currentVersion
    ? `${text.githubRelease}: v${currentVersion}`
    : text.githubRelease
      ...
      >
        ...
        >
          <section className={styles['update-window-about-section']} aria-labelledby="update-window-product-name">
            ...
            {releasePageUrl ? (
              <Tooltip title={releasePageLabel}>
                <a
                  className={styles['update-window-release-link']}
                  href={releasePageUrl}
                  target="_blank"
                  rel="noreferrer"
                  aria-label={releasePageLabel}
                >
                  <GithubMarkIcon />
                </a>
              </Tooltip>
