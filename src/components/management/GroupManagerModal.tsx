...
import type { GroupReorderItem } from '../../types/domain'
...
export function GroupManagerModal<T extends GroupManagerItem>({
  ...
  const startDrag = (event: DragEvent<HTMLElement>, groupId: string) => {
    ...
    const row = event.currentTarget.closest('.group-manager-row')
  ...
  return (
    <Modal
      ...
      footer={null}
      title={(
        <span className="group-manager-title">
          <span className="group-manager-title-icon"><FolderCog size={17} aria-hidden="true" /></span>
          <span>{title}</span>
          <small>{orderedGroups.length}</small>
        </span>
      )}
      rootClassName="group-manager-modal"
      onCancel={onClose}
    >
      <div className="group-manager-create-row">
        <Input
      ...
      <div className="group-manager-list-shell">
              ...
              return (
                ...
                >
                  <Tooltip title={reorderLabel}>
                    <Button
                      type="text"
                      className="group-manager-drag-handle"
                  ...
                  <span className="group-manager-row-icon"><Folder size={16} /></span>
                  <span className="group-manager-row-copy">
                    {editing ? (
                      <Input
                        autoFocus
                  ...
                  <div className="group-manager-row-actions">
                    {editing ? (
                      <>
                      ...
                      <>
                        <span className="group-manager-order-actions">
